...
<html lang="en">
  ...
  <body>
    <h1 class="text-center mb-4">Tambah Data Santri</h1>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
           ...
           <form action="/insertdata" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Pindahan</label>
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Alamat Orang Tua Sekarang</label>
